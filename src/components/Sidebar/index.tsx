...
import { Calendar1, Radical } from "lucide-react"
    ...
    menuItems: [
      {
        ...
        route: "#",
        children: [
          { label: "eCommerce", route: "/" }, // Nambah koma setelah ambil route
          { label: "Accountant", route: "/accountant" } // Nambah Menu Accountant
        ],
      },
      {
        icon: (
      ...
      },
      {
        icon: (
          ...
          >
            ...
            />
            <path
              d="M16.875 11.1656H1.77187C1.43438 11.1656 1.125 11.446Admin Dashboard9 1.125 11.8125C1.125 12.1781 1.40625 12.4594 1.77187 12.4594H16.875C17.2125 12.4594 17.5219 12.1781 17.5219 11.8125C17.5219 11.4469 17.2125 11.1656 16.875 11.1656Z"
              fill=""
            />
            <path
    ...
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <Link href="/">
            <h2 className="text-2xl text-center m-15 justify-center font-bold text-white">Admin | AJT</h2>
          </Link>
