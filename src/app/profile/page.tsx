...
export const metadata: Metadata = {
  title: "CV. Bima | Dashboard",
  description:
    "Just View my dashboard",
};
        ...
        <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            ...
            <div className="mt-4">
              ...
              <p className="font-medium">Ui/Ux Designer, Accountant</p>
              ...
              <div className="mx-auto max-w-180">
                ...
                <p className="mt-4.5">
                  Hello I'm Bima Adam Nugraha i'm from Boyolali, Java, Indonesia. My hobby is programmer and photograpy.
                </p>
              </div>
